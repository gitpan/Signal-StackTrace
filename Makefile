# This Makefile is for the Signal::StackTrace extension to perl.
#
...
#     ABSTRACT_FROM => q[./lib/Signal/StackTrace.pm]
#     NAME => q[Signal::StackTrace]
#     PREREQ_PM => { strict=>q[0], Data::Dumper=>q[0], Config=>q[0], Carp=>q[0] }
#     VERSION_FROM => q[./lib/Signal/StackTrace.pm]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Signal/StackTrace.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Signal
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Signal
...
TO_INST_PM = lib/Signal/StackTrace.pm

PM_TO_BLIB = lib/Signal/StackTrace.pm \
...
DISTNAME = Signal-StackTrace
DISTVNAME = Signal-StackTrace-0.01
...
manifypods : pure_all  \
	lib/Signal/StackTrace.pm \
	lib/Signal/StackTrace.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Signal/StackTrace.pm $(INST_MAN3DIR)/Signal::StackTrace.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         Signal-StackTrace' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: ./lib/Signal/StackTrace.pm' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>install signal handler to print a stacktrace.</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/Signal/StackTrace.pm blib/lib/Signal/StackTrace.pm 
